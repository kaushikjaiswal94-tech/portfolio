      ...
      <section id="home" className="hero-section">
        <div className="hero-content">
          <div className="hero-copy">
            ...
            <a href="https://github.com/kaushikjaiswal94-tech" className="social-icon" title="GitHub" target="_blank" rel="noopener noreferrer">
          ...
          <div className="contact-content">
            <div className="contact-info">
              <div className="info-item">
                <h4>Email</h4>
                <a href="mailto:kaushikjaiswal94@gmail.com">kaushikjaiswal94@gmail.com</a>
              </div>
              <div className="info-item">
                <h4>GitHub</h4>
                <a href="https://github.com/kaushikjaiswal94-tech" target="_blank" rel="noopener noreferrer">github.com/kaushikjaiswal94-tech</a>
              </div>
              <div className="info-item">
                <h4>Phone</h4>
                <a href="tel:+917498377300">+91 74983 77300</a>
              </div>
            </div>
            <a href="mailto:kaushikjaiswal94@gmail.com" className="btn btn-primary">Send Me an Email</a>
          </div>
        </div>
      </section>
